...
/**
 * @fileOverview A Text-to-Speech (TTS) service for notes.
 *
...
const TextToSpeechOutputSchema = z.object({
  audio: z.string().describe("A data URI representing the audio file. Format: 'data:audio/wav;base64,<encoded_data>'."),
});
